...
- [Claude Code](https://claude.ai/code) installed and used in the same workspace
...
Built in public: [github.com/ChrisZhang/devvalue](https://github.com/ChrisZhang/devvalue)
